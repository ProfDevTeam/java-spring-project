...
import uz.pdp.pdpspring6thlessonhomework2nd.component.NumberGenerator;
import uz.pdp.pdpspring6thlessonhomework2nd.component.SerialNumberGenerator;
...
import uz.pdp.pdpspring6thlessonhomework2nd.payload.SimCardDto;
import uz.pdp.pdpspring6thlessonhomework2nd.repository.*;
...
public class SimCardService {
    ...
    public ApiResponse getUssdCode(String ussdCode) {
        ...
        if (ussdCode.equals("*100#")) {
            ...
            return new ApiResponse("Sizning internet trafik qoldig'inggiz", true, amountMb);
